...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    FICHERO = 260,                 /* FICHERO  */
    COMANDO_BASICO = 261,          /* COMANDO_BASICO  */
    IMPRIMIR = 262,                /* IMPRIMIR  */
    ON = 263,                      /* ON  */
    OFF = 264,                     /* OFF  */
    ...
    MENOS_MENOS = 274,             /* MENOS_MENOS  */
    MAS_IGUAL = 275,               /* MAS_IGUAL  */
    MAS_MAS = 276,                 /* MAS_MAS  */
    POR_IGUAL = 277,               /* POR_IGUAL  */
    DIVIDIDO_IGUAL = 278,          /* DIVIDIDO_IGUAL  */
    MENOR_IGUAL = 279,             /* MENOR_IGUAL  */
    MAYOR_IGUAL = 280,             /* MAYOR_IGUAL  */
    DISTINTO = 281,                /* DISTINTO  */
...
#line 97 "analizadorSintactico.tab.h"
